...
class OrderServiceTest {
	...
	void 상품주문() {
		...
		assertEquals(1, getOrder.getOrderItems().size(), "상품 종류 갯수");
	...
	void 주문취소() {
		...
		assertEquals(10, book.getStockQuantity(), "주문이 취소된 상품은 그만큼 재고가 증가");
	}
	...
	private Member createMember() {
		...
		member.setName("회원1");
		member.setAddress(new Address("서울", "길", "192-111"));
		em.persist(member);
		return member;
	}
