...
public class MemberApiController {
	...
	*/
	...
	public CreateMemberResponse saveMemberV2(@RequestBody @Valid CreateMemberRequest request) {
		...
		Long id = memberService.join(member);
		return new CreateMemberResponse(id);//id를 반환한 다는 것을 알 수 있음
	}
	
	@Data
	static class CreateMemberRequest{//name만 가지는 것을 알 수 있음
		private String name;
		
		/*
		 * CreateMemberRequest(Long id){ this.id = id; }
		 */
	}
	...
	*/
	...
	/*
	 * 외부에서 인자 넘겨주는 request 같은 경우 static 안붙이면
